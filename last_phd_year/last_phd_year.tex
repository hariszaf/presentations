...
\begin{document}
   ...
   \begin{frame}
      ...
      \includegraphics[width=95mm]{resources/abstract_microbetag.png}
   \end{frame}



   \begin{frame}
      \frametitle{a part of an example of an annotated network}
      \framesubtitle{let me know if you'd like to be a beta-tester!}
      ...
      \begin{columns}[onlytextwidth]
         ...
         \column{0.50\textwidth}
            \includegraphics[width=60mm]{resources/mggNodeExample.png}

         \column{0.50\textwidth}
            \includegraphics[width=60mm]{resources/mggEdgeExample.png}
