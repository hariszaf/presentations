...
\begin{document}
            ...
            \node[anchor=west]
              at (current page.north west){
               \begin{textblock*}{5cm}(0.8cm, 3.5cm)
                  \scriptsize
                  \begin{itemize}
                     \item sequencing technology oriented           % genetic variance, broken pieces, alive and dead 
                     \item \textbf{eDNA-}, sample process-, primers-, PCR-oriented       % resolytion, primets, pcr biases 
                     \item \textbf{complex bioinformatics analysis}
                     \item \textbf{analysis reproducibility}
                     \item \textbf{computing requirements}            % storage, memory, algorithm 
                     \item \textbf{algorithm-oriented} 
                     \item versioning of reference databases \& tools 
                     \item standards, ontologies
   ...
   \begin{darkframes}
      \begin{frame}
         ...
         \begin{tikzpicture}[overlay,remember picture]
            \node[anchor=east, xshift=-294,yshift=42pt]
               at (current page.east) {
   ...
   \begin{frame}
      ...
      \frametitle{Publicly available omics data sets}
