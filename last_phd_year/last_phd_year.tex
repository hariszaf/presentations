...
\begin{document}
   ...
   \begin{frame}
      ...
      \begin{textblock*}{6cm}(1.0cm, 8.0cm)
         \small The PREGO knowledge-base is already available under \href{http://prego.hcmr.gr/}{http://prego.hcmr.gr/}.
      \end{textblock*}
   ...
   % % LAST THING TO DO ON MY PHD
   % \begin{frame}
   %    \frametitle{A swamp in Karpathos}
   %    \framesubtitle{an Aegean island}
   %    \includegraphics[width=75mm]{resources/tristomo_swamp.png}

   %    \begin{textblock*}{3.0cm}(9.5cm, 5.0cm)
   %       one last stop \\ in the PhD route 
   %    \end{textblock*}
