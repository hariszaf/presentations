      ...
      \begin{singlespace}
         ...
         \begin{columns}[onlytextwidth]
            ...
            \column{.33\textwidth}
               ...
               \begin{tikzpicture}[overlay,remember picture]
                  \node[anchor=west, xshift=85pt,yshift=35pt]
                     at (current page.west) {
            ...
            \column{.33\textwidth}
               ...
               \begin{tikzpicture}[overlay,remember picture]
                  \node[anchor=west, xshift=185pt,yshift=35pt]
                     at (current page.west) {
            ...
            \node[anchor=east, xshift=30pt,yshift=-165pt]
              at (current page.north east){
               \begin{textblock*}{3cm}(9.0cm, 3.5cm)
                  \small	
                  community ecology studies with \textbf{no \textit{a priori}} assumptions about the organisms under consideration, \\
                  \small	
                  by exploiting \textbf{HTS and systems biology} approaches
               \end{textblock*}
