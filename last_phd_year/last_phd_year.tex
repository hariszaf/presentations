...
\begin{document}
   ...
   %       \begin{tikzpicture}[overlay,remember picture]
   %          \node[anchor=east, xshift=-294,yshift=12pt]
   %             at (current page.east) {
   %                \includegraphics[width=14mm]{resources/who-yellow.png}
   %             };
   %             \node[anchor=east, xshift=-234,yshift=12pt]
   %             at (current page.east) {
   %                \includegraphics[width=14mm]{resources/what-yellow.png}
   %             };
   %             \node[anchor=east, xshift=-174,yshift=12pt]
   %             at (current page.east) {
   ...
   %       \begin{tikzpicture}[overlay,remember picture]
   %          \node[anchor=east, xshift=-294,yshift=30pt]
   %             at (current page.east) {
   %                \includegraphics[width=14mm]{resources/how-yellow.png}
   %             };
   %          \end{tikzpicture}
