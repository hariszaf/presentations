...
Finally, metabolic modeling has been providing with great insight for over the last 30 years, 
however it is only recently that has been used at the community level. 

In the next 40' I will try to highlight how each of my disseration chapters 
...
### slide 2: microbial ecology in general
...
### slide 7: graphical abstract

In this figure an overview of my PhD-related work is shown. 
