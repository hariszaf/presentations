...
\begin{document}
   ...
   \AtBeginSection[]{
      ...
      \begin{frame}<beamer>
         ...
         \tableofcontents
         % using the command \tableofcontents[currentsection]
         % the tocs of the current section are highlighted
      \end{frame}
   ...
   \begin{darkframes}
      ...
      \begin{frame}[label=figs2]{Figures}
         ...
         %   Here is where the graph starts as a FIGURE
         \begin{figure}[b]
            \centering
      ...
      % Codin chunks - build the sleepSort object
      ...
      %   Slide 9 - use the sleepSort object
   ...
   \begin{frame}{Thank you for your attention}
         ...
         GitHub   : \href{https://github.com/hariszaf}{hariszaf} \\ 
